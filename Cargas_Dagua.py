...
def main():
    ''' Controla a interação do jogo.
    '''
    #leitura da semente para criar o simulador
    semente = int(input("Digite o valor para o gerador de cargas: "))
...
class Balde:
    '''
        ...
        Ela armazena tambem o volume derramado e indica se esta cheio.
    '''
    def __init__(self, c):
        self.cap = c
    ...
    def deposita(self, v):
        '''
            Deposita um volume de agua (v) e atualiza o Balde.
        '''
        self.vol += v
...
class Simulador:
    ...
    def deposita(self):
        ...
        if self.rec.vol >= self.rec.cap/2 and not self.avisou:
            self.avisou = True
            print("O volume atingiu/passou a metade.")
    ...
    def finaliza(self):
        ...
        if self.rec.der > 0:
            ...
            if self.rec.cheio:
                ...
                print("Balde nao esta cheio.")
                print("Nao havia espaco para o ultimo volume sorteaado: %d" % self.vol)
